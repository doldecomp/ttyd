...
/* 80083A90 00080A90  41 82 00 28 */	beq lbl_80083AB8
...
/* 80083AB4 00080AB4  48 00 00 08 */	b lbl_80083ABC
lbl_80083AB8:
...
/* 80083AF8 00080AF8  41 82 00 08 */	beq lbl_80083B00
/* 80083AFC 00080AFC  48 00 00 38 */	b lbl_80083B34
lbl_80083B00:
...
/* 80083B30 00080B30  48 00 02 18 */	b lbl_80083D48
lbl_80083B34:
...
/* 80083B5C 00080B5C  48 00 00 EC */	b lbl_80083C48
lbl_80083B60:
...
/* 80083B6C 00080B6C  40 82 00 40 */	bne lbl_80083BAC
/* 80083B70 00080B70  88 E8 00 01 */	lbz r7, 1(r8)
/* 80083B74 00080B74  2C 07 00 2F */	cmpwi r7, 0x2f
/* 80083B78 00080B78  40 82 00 34 */	bne lbl_80083BAC
...
/* 80083B88 00080B88  40 80 00 BC */	bge lbl_80083C44
lbl_80083B8C:
...
/* 80083B98 00080B98  41 82 00 AC */	beq lbl_80083C44
/* 80083B9C 00080B9C  39 4A 00 01 */	addi r10, r10, 1
/* 80083BA0 00080BA0  39 08 00 01 */	addi r8, r8, 1
/* 80083BA4 00080BA4  42 00 FF E8 */	bdnz lbl_80083B8C
/* 80083BA8 00080BA8  48 00 00 9C */	b lbl_80083C44
lbl_80083BAC:
/* 80083BAC 00080BAC  7D 27 07 74 */	extsb r7, r9
/* 80083BB0 00080BB0  2C 07 00 20 */	cmpwi r7, 0x20
/* 80083BB4 00080BB4  41 82 00 90 */	beq lbl_80083C44
/* 80083BB8 00080BB8  2C 07 00 09 */	cmpwi r7, 9
/* 80083BBC 00080BBC  41 82 00 88 */	beq lbl_80083C44
/* 80083BC0 00080BC0  2C 07 00 0A */	cmpwi r7, 0xa
/* 80083BC4 00080BC4  41 82 00 80 */	beq lbl_80083C44
/* 80083BC8 00080BC8  2C 07 00 0D */	cmpwi r7, 0xd
/* 80083BCC 00080BCC  41 82 00 78 */	beq lbl_80083C44
...
/* 80083BE8 00080BE8  40 80 00 68 */	bge lbl_80083C50
lbl_80083BEC:
...
/* 80083BFC 00080BFC  41 82 00 30 */	beq lbl_80083C2C
...
/* 80083C0C 00080C0C  40 81 00 20 */	ble lbl_80083C2C
/* 80083C10 00080C10  2C 08 00 0D */	cmpwi r8, 0xd
/* 80083C14 00080C14  41 82 00 18 */	beq lbl_80083C2C
/* 80083C18 00080C18  2C 08 00 2F */	cmpwi r8, 0x2f
/* 80083C1C 00080C1C  40 82 00 1C */	bne lbl_80083C38
/* 80083C20 00080C20  88 E9 00 01 */	lbz r7, 1(r9)
/* 80083C24 00080C24  2C 07 00 2F */	cmpwi r7, 0x2f
/* 80083C28 00080C28  40 82 00 10 */	bne lbl_80083C38
lbl_80083C2C:
/* 80083C2C 00080C2C  7D 5E 53 78 */	mr r30, r10
/* 80083C30 00080C30  38 A0 00 02 */	li r5, 2
/* 80083C34 00080C34  48 00 00 1C */	b lbl_80083C50
lbl_80083C38:
/* 80083C38 00080C38  39 4A 00 01 */	addi r10, r10, 1
/* 80083C3C 00080C3C  42 00 FF B0 */	bdnz lbl_80083BEC
/* 80083C40 00080C40  48 00 00 10 */	b lbl_80083C50
lbl_80083C44:
/* 80083C44 00080C44  39 4A 00 01 */	addi r10, r10, 1
lbl_80083C48:
/* 80083C48 00080C48  7C 0A 00 00 */	cmpw r10, r0
/* 80083C4C 00080C4C  41 80 FF 14 */	blt lbl_80083B60
lbl_80083C50:
/* 80083C50 00080C50  2C 05 00 01 */	cmpwi r5, 1
/* 80083C54 00080C54  41 81 00 0C */	bgt lbl_80083C60
/* 80083C58 00080C58  38 60 00 00 */	li r3, 0
/* 80083C5C 00080C5C  48 00 00 EC */	b lbl_80083D48
lbl_80083C60:
/* 80083C60 00080C60  2C 03 00 01 */	cmpwi r3, 1
/* 80083C64 00080C64  41 82 00 AC */	beq lbl_80083D10
/* 80083C68 00080C68  40 80 00 10 */	bge lbl_80083C78
/* 80083C6C 00080C6C  2C 03 00 00 */	cmpwi r3, 0
/* 80083C70 00080C70  40 80 00 14 */	bge lbl_80083C84
/* 80083C74 00080C74  48 00 00 D0 */	b lbl_80083D44
lbl_80083C78:
/* 80083C78 00080C78  2C 03 00 03 */	cmpwi r3, 3
/* 80083C7C 00080C7C  40 80 00 C8 */	bge lbl_80083D44
/* 80083C80 00080C80  48 00 00 AC */	b lbl_80083D2C
lbl_80083C84:
...
/* 80083C94 00080C94  48 00 00 64 */	b lbl_80083CF8
lbl_80083C98:
/* 80083C98 00080C98  88 65 00 00 */	lbz r3, 0(r5)
/* 80083C9C 00080C9C  2C 03 00 22 */	cmpwi r3, 0x22
/* 80083CA0 00080CA0  40 82 00 50 */	bne lbl_80083CF0
...
/* 80083CC0 00080CC0  40 80 00 30 */	bge lbl_80083CF0
lbl_80083CC4:
/* 80083CC4 00080CC4  89 26 00 00 */	lbz r9, 0(r6)
/* 80083CC8 00080CC8  2C 09 00 22 */	cmpwi r9, 0x22
/* 80083CCC 00080CCC  41 82 00 24 */	beq lbl_80083CF0
...
/* 80083CEC 00080CEC  42 00 FF D8 */	bdnz lbl_80083CC4
lbl_80083CF0:
...
/* 80083CFC 00080CFC  41 80 FF 9C */	blt lbl_80083C98
...
/* 80083DE4 00080DE4  48 00 01 54 */	b lbl_80083F38
lbl_80083DE8:
...
/* 80083E84 00080E84  40 80 00 58 */	bge lbl_80083EDC
lbl_80083E88:
...
/* 80083E94 00080E94  41 82 00 28 */	beq lbl_80083EBC
/* 80083E98 00080E98  2C 00 00 09 */	cmpwi r0, 9
/* 80083E9C 00080E9C  41 82 00 20 */	beq lbl_80083EBC
/* 80083EA0 00080EA0  2C 00 00 0A */	cmpwi r0, 0xa
/* 80083EA4 00080EA4  41 82 00 18 */	beq lbl_80083EBC
/* 80083EA8 00080EA8  2C 00 00 0D */	cmpwi r0, 0xd
/* 80083EAC 00080EAC  41 82 00 10 */	beq lbl_80083EBC
...
/* 80083EF8 00080EF8  40 82 00 38 */	bne lbl_80083F30
...
/* 80083F3C 00080F3C  41 80 FE AC */	blt lbl_80083DE8
lbl_80083F40:
/* 80083F40 00080F40  2C 19 00 02 */	cmpwi r25, 2
/* 80083F44 00080F44  41 82 00 0C */	beq lbl_80083F50
/* 80083F48 00080F48  38 60 00 00 */	li r3, 0
/* 80083F4C 00080F4C  48 00 00 20 */	b lbl_80083F6C
lbl_80083F50:
