...
/* 801E85B4 001E55B4  C0 22 EB E0 */	lfs f1, lbl_8041FF60-_SDA2_BASE_(r2)
/* 801E85B8 001E55B8  38 61 00 A8 */	addi r3, r1, 0xa8
/* 801E85BC 001E55BC  C0 42 EB E4 */	lfs f2, lbl_8041FF64-_SDA2_BASE_(r2)
/* 801E85C0 001E55C0  C0 62 EB E8 */	lfs f3, lbl_8041FF68-_SDA2_BASE_(r2)
/* 801E85C4 001E55C4  C0 82 EB EC */	lfs f4, lbl_8041FF6C-_SDA2_BASE_(r2)
/* 801E85C8 001E55C8  C0 A2 EB F0 */	lfs f5, lbl_8041FF70-_SDA2_BASE_(r2)
/* 801E85CC 001E55CC  C0 C2 EB F4 */	lfs f6, lbl_8041FF74-_SDA2_BASE_(r2)
/* 801E85D0 001E55D0  48 0B 04 E5 */	bl C_MTXOrtho
/* 801E85D4 001E55D4  48 00 00 24 */	b lbl_801E85F8
lbl_801E85D8:
/* 801E85D8 001E55D8  C0 22 EB E0 */	lfs f1, lbl_8041FF60-_SDA2_BASE_(r2)
/* 801E85DC 001E55DC  38 61 00 A8 */	addi r3, r1, 0xa8
/* 801E85E0 001E55E0  C0 42 EB E4 */	lfs f2, lbl_8041FF64-_SDA2_BASE_(r2)
/* 801E85E4 001E55E4  C0 62 EB EC */	lfs f3, lbl_8041FF6C-_SDA2_BASE_(r2)
/* 801E85E8 001E55E8  C0 82 EB E8 */	lfs f4, lbl_8041FF68-_SDA2_BASE_(r2)
/* 801E85EC 001E55EC  C0 A2 EB F0 */	lfs f5, lbl_8041FF70-_SDA2_BASE_(r2)
/* 801E85F0 001E55F0  C0 C2 EB F4 */	lfs f6, lbl_8041FF74-_SDA2_BASE_(r2)
...
/* 801E862C 001E562C  80 62 1F 10 */	lwz r3, lbl_80423290-_SDA2_BASE_(r2)
...
/* 801E8668 001E5668  80 02 1F 14 */	lwz r0, lbl_80423294-_SDA2_BASE_(r2)
...
/* 801E8888 001E5888  C0 22 EB F8 */	lfs f1, lbl_8041FF78-_SDA2_BASE_(r2)
/* 801E888C 001E588C  38 61 00 E8 */	addi r3, r1, 0xe8
/* 801E8890 001E5890  C0 42 EB FC */	lfs f2, lbl_8041FF7C-_SDA2_BASE_(r2)
/* 801E8894 001E5894  C0 62 EC 00 */	lfs f3, lbl_8041FF80-_SDA2_BASE_(r2)
...
lbl_801E8904:
/* 801E8904 001E5904  C0 22 EC 04 */	lfs f1, lbl_8041FF84-_SDA2_BASE_(r2)
/* 801E8908 001E5908  38 61 00 E8 */	addi r3, r1, 0xe8
/* 801E890C 001E590C  C0 42 EC 08 */	lfs f2, lbl_8041FF88-_SDA2_BASE_(r2)
/* 801E8910 001E5910  C0 62 EC 00 */	lfs f3, lbl_8041FF80-_SDA2_BASE_(r2)
/* 801E8914 001E5914  48 0A FB 99 */	bl PSMTXScale
/* 801E8918 001E5918  6F E0 80 00 */	xoris r0, r31, 0x8000
/* 801E891C 001E591C  C0 42 EC 00 */	lfs f2, lbl_8041FF80-_SDA2_BASE_(r2)
...
/* 801E8D1C 001E5D1C  C0 22 EC 0C */	lfs f1, lbl_8041FF8C-_SDA2_BASE_(r2)
/* 801E8D20 001E5D20  3B 60 00 00 */	li r27, 0
/* 801E8D24 001E5D24  C8 01 00 20 */	lfd f0, 0x20(r1)
/* 801E8D28 001E5D28  C3 C2 EC 10 */	lfs f30, lbl_8041FF90-_SDA2_BASE_(r2)
/* 801E8D2C 001E5D2C  EC 00 E8 28 */	fsubs f0, f0, f29
/* 801E8D30 001E5D30  C3 E2 EC 14 */	lfs f31, lbl_8041FF94-_SDA2_BASE_(r2)
/* 801E8D34 001E5D34  C2 E2 EC 18 */	lfs f23, lbl_8041FF98-_SDA2_BASE_(r2)
/* 801E8D38 001E5D38  C3 02 EC 20 */	lfs f24, lbl_8041FFA0-_SDA2_BASE_(r2)
/* 801E8D3C 001E5D3C  EF 81 00 32 */	fmuls f28, f1, f0
/* 801E8D40 001E5D40  C3 22 EC 1C */	lfs f25, lbl_8041FF9C-_SDA2_BASE_(r2)
/* 801E8D44 001E5D44  C3 42 EC 00 */	lfs f26, lbl_8041FF80-_SDA2_BASE_(r2)
/* 801E8D48 001E5D48  C3 62 EC 24 */	lfs f27, lbl_8041FFA4-_SDA2_BASE_(r2)
lbl_801E8D4C:
...
/* 801E8DC0 001E5DC0  C0 02 EC 24 */	lfs f0, lbl_8041FFA4-_SDA2_BASE_(r2)
...
/* 801E8F38 001E5F38  C0 02 EC 00 */	lfs f0, lbl_8041FF80-_SDA2_BASE_(r2)
