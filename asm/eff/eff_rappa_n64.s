...
/* 801DC1C8 001D91C8  C0 22 E7 58 */	lfs f1, lbl_8041FAD8-_SDA2_BASE_(r2)
/* 801DC1CC 001D91CC  38 61 00 60 */	addi r3, r1, 0x60
/* 801DC1D0 001D91D0  C0 42 E7 5C */	lfs f2, lbl_8041FADC-_SDA2_BASE_(r2)
/* 801DC1D4 001D91D4  C0 62 E7 60 */	lfs f3, lbl_8041FAE0-_SDA2_BASE_(r2)
...
/* 801DC2A0 001D92A0  C3 E2 E7 64 */	lfs f31, lbl_8041FAE4-_SDA2_BASE_(r2)
...
/* 801DC2BC 001D92BC  48 00 01 5C */	b lbl_801DC418
lbl_801DC2C0:
/* 801DC2C0 001D92C0  7C 1F E8 96 */	mulhw r0, r31, r29
/* 801DC2C4 001D92C4  80 62 1E B0 */	lwz r3, lbl_80423230-_SDA2_BASE_(r2)
/* 801DC2C8 001D92C8  38 ED CA 70 */	addi r7, r13, lbl_80413CD0-_SDA_BASE_
...
/* 801DC380 001D9380  C0 62 E7 68 */	lfs f3, lbl_8041FAE8-_SDA2_BASE_(r2)
...
/* 801DC420 001D9420  41 80 FE A0 */	blt lbl_801DC2C0
...
/* 801DC4C8 001D94C8  40 80 00 0C */	bge lbl_801DC4D4
/* 801DC4CC 001D94CC  4B E8 16 B9 */	bl effDelete
/* 801DC4D0 001D94D0  48 00 01 58 */	b lbl_801DC628
lbl_801DC4D4:
/* 801DC4D4 001D94D4  2C 05 00 0A */	cmpwi r5, 0xa
/* 801DC4D8 001D94D8  40 80 00 40 */	bge lbl_801DC518
...
/* 801DC4F8 001D94F8  C0 02 E7 6C */	lfs f0, lbl_8041FAEC-_SDA2_BASE_(r2)
...
/* 801DC51C 001D951C  C0 62 E7 70 */	lfs f3, lbl_8041FAF0-_SDA2_BASE_(r2)
/* 801DC520 001D9520  38 60 00 01 */	li r3, 1
/* 801DC524 001D9524  38 E7 00 38 */	addi r7, r7, 0x38
/* 801DC528 001D9528  40 80 00 D4 */	bge lbl_801DC5FC
/* 801DC52C 001D952C  C0 22 E7 74 */	lfs f1, lbl_8041FAF4-_SDA2_BASE_(r2)
/* 801DC530 001D9530  48 00 00 68 */	b lbl_801DC598
lbl_801DC534:
...
/* 801DC5A0 001D95A0  41 80 FF 94 */	blt lbl_801DC534
/* 801DC5A4 001D95A4  48 00 00 64 */	b lbl_801DC608
/* 801DC5A8 001D95A8  48 00 00 54 */	b lbl_801DC5FC
lbl_801DC5AC:
...
/* 801DC604 001D9604  41 80 FF A8 */	blt lbl_801DC5AC
lbl_801DC608:
...
/* 801DC6E4 001D96E4  40 82 00 0C */	bne lbl_801DC6F0
/* 801DC6E8 001D96E8  38 60 00 00 */	li r3, 0
/* 801DC6EC 001D96EC  48 00 01 88 */	b lbl_801DC874
lbl_801DC6F0:
...
/* 801DC710 001D9710  C3 62 E7 78 */	lfs f27, lbl_8041FAF8-_SDA2_BASE_(r2)
...
/* 801DC724 001D9724  C3 E2 E7 84 */	lfs f31, lbl_8041FB04-_SDA2_BASE_(r2)
...
/* 801DC768 001D9768  C3 A2 E7 80 */	lfs f29, lbl_8041FB00-_SDA2_BASE_(r2)
/* 801DC76C 001D976C  3F 20 43 30 */	lis r25, 0x4330
/* 801DC770 001D9770  90 E3 00 30 */	stw r7, 0x30(r3)
/* 801DC774 001D9774  C3 C2 E7 7C */	lfs f30, lbl_8041FAFC-_SDA2_BASE_(r2)
/* 801DC778 001D9778  90 C3 00 34 */	stw r6, 0x34(r3)
/* 801DC77C 001D977C  C2 82 E7 74 */	lfs f20, lbl_8041FAF4-_SDA2_BASE_(r2)
/* 801DC780 001D9780  90 03 00 2C */	stw r0, 0x2c(r3)
/* 801DC784 001D9784  48 00 00 E4 */	b lbl_801DC868
lbl_801DC788:
...
/* 801DC86C 001D986C  41 80 FF 1C */	blt lbl_801DC788
