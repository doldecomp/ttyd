...
/* 801AE4A0 001AB4A0  C0 02 D7 9C */	lfs f0, lbl_8041EB1C-_SDA2_BASE_(r2)
...
/* 801AE4D4 001AB4D4  80 A2 D7 98 */	lwz r5, lbl_8041EB18-_SDA2_BASE_(r2)
...
/* 801AE548 001AB548  C0 22 D7 A0 */	lfs f1, lbl_8041EB20-_SDA2_BASE_(r2)
/* 801AE54C 001AB54C  38 61 00 90 */	addi r3, r1, 0x90
/* 801AE550 001AB550  C0 42 D7 A4 */	lfs f2, lbl_8041EB24-_SDA2_BASE_(r2)
/* 801AE554 001AB554  C0 62 D7 A8 */	lfs f3, lbl_8041EB28-_SDA2_BASE_(r2)
...
/* 801AE6C4 001AB6C4  C3 E2 D7 9C */	lfs f31, lbl_8041EB1C-_SDA2_BASE_(r2)
...
/* 801AE94C 001AB94C  C0 62 D7 AC */	lfs f3, lbl_8041EB2C-_SDA2_BASE_(r2)
...
/* 801AE9A0 001AB9A0  C0 02 D7 B0 */	lfs f0, lbl_8041EB30-_SDA2_BASE_(r2)
...
/* 801AE9C8 001AB9C8  C2 E2 D7 B4 */	lfs f23, lbl_8041EB34-_SDA2_BASE_(r2)
/* 801AE9CC 001AB9CC  3B 64 85 1F */	addi r27, r4, 0x51EB851F@l
/* 801AE9D0 001AB9D0  C3 02 D7 B8 */	lfs f24, lbl_8041EB38-_SDA2_BASE_(r2)
/* 801AE9D4 001AB9D4  3B 40 00 01 */	li r26, 1
/* 801AE9D8 001AB9D8  C3 22 D7 BC */	lfs f25, lbl_8041EB3C-_SDA2_BASE_(r2)
/* 801AE9DC 001AB9DC  3F 80 43 30 */	lis r28, 0x4330
/* 801AE9E0 001AB9E0  C3 42 D7 C0 */	lfs f26, lbl_8041EB40-_SDA2_BASE_(r2)
/* 801AE9E4 001AB9E4  3B FF 00 34 */	addi r31, r31, 0x34
/* 801AE9E8 001AB9E8  C3 62 D7 C4 */	lfs f27, lbl_8041EB44-_SDA2_BASE_(r2)
/* 801AE9EC 001AB9EC  CB 83 A3 88 */	lfd f28, lbl_802FA388@l(r3)
/* 801AE9F0 001AB9F0  C3 A2 D7 D8 */	lfs f29, lbl_8041EB58-_SDA2_BASE_(r2)
/* 801AE9F4 001AB9F4  C3 C2 D7 DC */	lfs f30, lbl_8041EB5C-_SDA2_BASE_(r2)
/* 801AE9F8 001AB9F8  C3 E2 D7 E0 */	lfs f31, lbl_8041EB60-_SDA2_BASE_(r2)
...
/* 801AEA40 001ABA40  C0 02 D7 C8 */	lfs f0, lbl_8041EB48-_SDA2_BASE_(r2)
/* 801AEA44 001ABA44  C0 42 D7 B4 */	lfs f2, lbl_8041EB34-_SDA2_BASE_(r2)
/* 801AEA48 001ABA48  EC 21 00 32 */	fmuls f1, f1, f0
/* 801AEA4C 001ABA4C  C0 02 D7 BC */	lfs f0, lbl_8041EB3C-_SDA2_BASE_(r2)
...
/* 801AEA68 001ABA68  C0 22 D7 D0 */	lfs f1, lbl_8041EB50-_SDA2_BASE_(r2)
/* 801AEA6C 001ABA6C  C0 02 D7 CC */	lfs f0, lbl_8041EB4C-_SDA2_BASE_(r2)
...
/* 801AEA88 001ABA88  C0 02 D7 D4 */	lfs f0, lbl_8041EB54-_SDA2_BASE_(r2)
...
/* 801AEC7C 001ABC7C  C3 E2 D7 A8 */	lfs f31, lbl_8041EB28-_SDA2_BASE_(r2)
