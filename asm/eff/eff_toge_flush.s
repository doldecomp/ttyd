...
/* 8018F0D4 0018C0D4  C0 02 CF C4 */	lfs f0, lbl_8041E344-_SDA2_BASE_(r2)
...
/* 8018F184 0018C184  80 02 1C F0 */	lwz r0, lbl_80423070-_SDA2_BASE_(r2)
/* 8018F188 0018C188  38 63 AA AB */	addi r3, r3, 0x2AAAAAAB@l
/* 8018F18C 0018C18C  38 AD B4 78 */	addi r5, r13, lbl_804126D8-_SDA_BASE_
...
lbl_8018F1E4:
/* 8018F1E4 0018C1E4  80 02 CF A8 */	lwz r0, lbl_8041E328-_SDA2_BASE_(r2)
...
lbl_8018F208:
/* 8018F208 0018C208  80 02 CF AC */	lwz r0, lbl_8041E32C-_SDA2_BASE_(r2)
...
lbl_8018F22C:
/* 8018F22C 0018C22C  80 02 CF B0 */	lwz r0, lbl_8041E330-_SDA2_BASE_(r2)
...
lbl_8018F250:
/* 8018F250 0018C250  80 02 CF B4 */	lwz r0, lbl_8041E334-_SDA2_BASE_(r2)
...
/* 8018F280 0018C280  C0 02 CF C8 */	lfs f0, lbl_8041E348-_SDA2_BASE_(r2)
/* 8018F284 0018C284  3C 60 CC 01 */	lis r3, 0xCC008000@ha
/* 8018F288 0018C288  D0 03 80 00 */	stfs f0, 0xCC008000@l(r3)
/* 8018F28C 0018C28C  C0 02 CF CC */	lfs f0, lbl_8041E34C-_SDA2_BASE_(r2)
/* 8018F290 0018C290  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F294 0018C294  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F298 0018C298  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F29C 0018C29C  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F2A0 0018C2A0  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F2A4 0018C2A4  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F2A8 0018C2A8  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F2AC 0018C2AC  C0 02 CF CC */	lfs f0, lbl_8041E34C-_SDA2_BASE_(r2)
/* 8018F2B0 0018C2B0  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F2B4 0018C2B4  C0 02 CF CC */	lfs f0, lbl_8041E34C-_SDA2_BASE_(r2)
/* 8018F2B8 0018C2B8  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F2BC 0018C2BC  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F2C0 0018C2C0  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F2C4 0018C2C4  C0 02 CF D4 */	lfs f0, lbl_8041E354-_SDA2_BASE_(r2)
/* 8018F2C8 0018C2C8  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F2CC 0018C2CC  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F2D0 0018C2D0  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F2D4 0018C2D4  C0 02 CF CC */	lfs f0, lbl_8041E34C-_SDA2_BASE_(r2)
/* 8018F2D8 0018C2D8  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F2DC 0018C2DC  C0 02 CF C8 */	lfs f0, lbl_8041E348-_SDA2_BASE_(r2)
/* 8018F2E0 0018C2E0  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F2E4 0018C2E4  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F2E8 0018C2E8  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F2EC 0018C2EC  C0 02 CF D4 */	lfs f0, lbl_8041E354-_SDA2_BASE_(r2)
/* 8018F2F0 0018C2F0  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F2F4 0018C2F4  C0 02 CF D4 */	lfs f0, lbl_8041E354-_SDA2_BASE_(r2)
/* 8018F2F8 0018C2F8  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F2FC 0018C2FC  C0 02 CF C8 */	lfs f0, lbl_8041E348-_SDA2_BASE_(r2)
/* 8018F300 0018C300  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F304 0018C304  C0 02 CF C8 */	lfs f0, lbl_8041E348-_SDA2_BASE_(r2)
/* 8018F308 0018C308  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F30C 0018C30C  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F310 0018C310  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F314 0018C314  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F318 0018C318  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F31C 0018C31C  C0 02 CF D4 */	lfs f0, lbl_8041E354-_SDA2_BASE_(r2)
...
/* 8018F360 0018C360  C0 22 CF C4 */	lfs f1, lbl_8041E344-_SDA2_BASE_(r2)
...
lbl_8018F3CC:
/* 8018F3CC 0018C3CC  80 02 CF B8 */	lwz r0, lbl_8041E338-_SDA2_BASE_(r2)
...
lbl_8018F3F0:
/* 8018F3F0 0018C3F0  80 02 CF BC */	lwz r0, lbl_8041E33C-_SDA2_BASE_(r2)
...
lbl_8018F414:
/* 8018F414 0018C414  80 02 CF C0 */	lwz r0, lbl_8041E340-_SDA2_BASE_(r2)
...
/* 8018F444 0018C444  C0 02 CF D8 */	lfs f0, lbl_8041E358-_SDA2_BASE_(r2)
/* 8018F448 0018C448  3C 60 CC 01 */	lis r3, 0xCC008000@ha
/* 8018F44C 0018C44C  D0 03 80 00 */	stfs f0, 0xCC008000@l(r3)
/* 8018F450 0018C450  C0 02 CF DC */	lfs f0, lbl_8041E35C-_SDA2_BASE_(r2)
/* 8018F454 0018C454  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F458 0018C458  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F45C 0018C45C  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F460 0018C460  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F464 0018C464  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F468 0018C468  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F46C 0018C46C  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F470 0018C470  C0 02 CF DC */	lfs f0, lbl_8041E35C-_SDA2_BASE_(r2)
/* 8018F474 0018C474  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F478 0018C478  C0 02 CF DC */	lfs f0, lbl_8041E35C-_SDA2_BASE_(r2)
/* 8018F47C 0018C47C  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F480 0018C480  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F484 0018C484  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F488 0018C488  C0 02 CF D4 */	lfs f0, lbl_8041E354-_SDA2_BASE_(r2)
/* 8018F48C 0018C48C  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F490 0018C490  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F494 0018C494  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F498 0018C498  C0 02 CF DC */	lfs f0, lbl_8041E35C-_SDA2_BASE_(r2)
/* 8018F49C 0018C49C  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F4A0 0018C4A0  C0 02 CF D8 */	lfs f0, lbl_8041E358-_SDA2_BASE_(r2)
/* 8018F4A4 0018C4A4  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F4A8 0018C4A8  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F4AC 0018C4AC  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F4B0 0018C4B0  C0 02 CF D4 */	lfs f0, lbl_8041E354-_SDA2_BASE_(r2)
/* 8018F4B4 0018C4B4  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F4B8 0018C4B8  C0 02 CF D4 */	lfs f0, lbl_8041E354-_SDA2_BASE_(r2)
/* 8018F4BC 0018C4BC  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F4C0 0018C4C0  C0 02 CF D8 */	lfs f0, lbl_8041E358-_SDA2_BASE_(r2)
/* 8018F4C4 0018C4C4  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F4C8 0018C4C8  C0 02 CF D8 */	lfs f0, lbl_8041E358-_SDA2_BASE_(r2)
/* 8018F4CC 0018C4CC  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F4D0 0018C4D0  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F4D4 0018C4D4  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F4D8 0018C4D8  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F4DC 0018C4DC  D0 03 80 00 */	stfs f0, -0x8000(r3)
/* 8018F4E0 0018C4E0  C0 02 CF D4 */	lfs f0, lbl_8041E354-_SDA2_BASE_(r2)
...
/* 8018F578 0018C578  C0 62 CF E0 */	lfs f3, lbl_8041E360-_SDA2_BASE_(r2)
...
/* 8018F5CC 0018C5CC  C0 02 CF E4 */	lfs f0, lbl_8041E364-_SDA2_BASE_(r2)
...
/* 8018F680 0018C680  C0 62 CF F0 */	lfs f3, lbl_8041E370-_SDA2_BASE_(r2)
/* 8018F684 0018C684  90 01 00 24 */	stw r0, 0x24(r1)
/* 8018F688 0018C688  C0 02 CF F4 */	lfs f0, lbl_8041E374-_SDA2_BASE_(r2)
/* 8018F68C 0018C68C  C8 21 00 20 */	lfd f1, 0x20(r1)
/* 8018F690 0018C690  C0 82 CF E0 */	lfs f4, lbl_8041E360-_SDA2_BASE_(r2)
/* 8018F694 0018C694  EC 21 10 28 */	fsubs f1, f1, f2
/* 8018F698 0018C698  C0 42 CF F8 */	lfs f2, lbl_8041E378-_SDA2_BASE_(r2)
...
/* 8018F6B8 0018C6B8  C0 22 D0 00 */	lfs f1, lbl_8041E380-_SDA2_BASE_(r2)
/* 8018F6BC 0018C6BC  38 C3 8E 80 */	addi r6, r3, lbl_802F8E80@l
/* 8018F6C0 0018C6C0  C0 02 CF FC */	lfs f0, lbl_8041E37C-_SDA2_BASE_(r2)
...
/* 8018F7C8 0018C7C8  C0 02 CF D0 */	lfs f0, lbl_8041E350-_SDA2_BASE_(r2)
...
lbl_8018F7F8:
/* 8018F7F8 0018C7F8  C0 02 D0 04 */	lfs f0, lbl_8041E384-_SDA2_BASE_(r2)
...
lbl_8018F808:
/* 8018F808 0018C808  C0 22 CF D0 */	lfs f1, lbl_8041E350-_SDA2_BASE_(r2)
/* 8018F80C 0018C80C  38 00 00 00 */	li r0, 0
/* 8018F810 0018C810  C0 02 D0 08 */	lfs f0, lbl_8041E388-_SDA2_BASE_(r2)
