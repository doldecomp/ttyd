...
/* 801DECDC 001DBCDC  C0 42 E8 4C */	lfs f2, lbl_8041FBCC-_SDA2_BASE_(r2)
...
/* 801DEF34 001DBF34  C0 02 E8 50 */	lfs f0, lbl_8041FBD0-_SDA2_BASE_(r2)
...
/* 801DEF68 001DBF68  80 02 E8 48 */	lwz r0, lbl_8041FBC8-_SDA2_BASE_(r2)
...
/* 801DEF7C 001DBF7C  80 02 1E D0 */	lwz r0, lbl_80423250-_SDA2_BASE_(r2)
...
/* 801DEF9C 001DBF9C  C0 22 E8 54 */	lfs f1, lbl_8041FBD4-_SDA2_BASE_(r2)
/* 801DEFA0 001DBFA0  57 7B 28 34 */	slwi r27, r27, 5
/* 801DEFA4 001DBFA4  C0 42 E8 58 */	lfs f2, lbl_8041FBD8-_SDA2_BASE_(r2)
/* 801DEFA8 001DBFA8  38 61 00 94 */	addi r3, r1, 0x94
/* 801DEFAC 001DBFAC  C0 62 E8 5C */	lfs f3, lbl_8041FBDC-_SDA2_BASE_(r2)
...
/* 801DEFC4 001DBFC4  C0 42 E8 5C */	lfs f2, lbl_8041FBDC-_SDA2_BASE_(r2)
...
/* 801DF008 001DC008  41 82 00 70 */	beq lbl_801DF078
/* 801DF00C 001DC00C  C0 22 E8 54 */	lfs f1, lbl_8041FBD4-_SDA2_BASE_(r2)
/* 801DF010 001DC010  38 61 00 94 */	addi r3, r1, 0x94
/* 801DF014 001DC014  C0 42 E8 58 */	lfs f2, lbl_8041FBD8-_SDA2_BASE_(r2)
/* 801DF018 001DC018  C0 62 E8 5C */	lfs f3, lbl_8041FBDC-_SDA2_BASE_(r2)
...
/* 801DF040 001DC040  C0 42 E8 60 */	lfs f2, lbl_8041FBE0-_SDA2_BASE_(r2)
/* 801DF044 001DC044  C8 01 01 10 */	lfd f0, 0x110(r1)
/* 801DF048 001DC048  C0 62 E8 5C */	lfs f3, lbl_8041FBDC-_SDA2_BASE_(r2)
...
/* 801DF074 001DC074  48 00 00 6C */	b lbl_801DF0E0
lbl_801DF078:
/* 801DF078 001DC078  C0 22 E8 54 */	lfs f1, lbl_8041FBD4-_SDA2_BASE_(r2)
/* 801DF07C 001DC07C  38 61 00 94 */	addi r3, r1, 0x94
/* 801DF080 001DC080  C0 42 E8 58 */	lfs f2, lbl_8041FBD8-_SDA2_BASE_(r2)
/* 801DF084 001DC084  C0 62 E8 5C */	lfs f3, lbl_8041FBDC-_SDA2_BASE_(r2)
...
/* 801DF0A4 001DC0A4  C0 42 E8 5C */	lfs f2, lbl_8041FBDC-_SDA2_BASE_(r2)
...
/* 801DF0E8 001DC0E8  48 00 00 78 */	b lbl_801DF160
lbl_801DF0EC:
...
/* 801DF168 001DC168  41 80 FF 84 */	blt lbl_801DF0EC
...
/* 801DF19C 001DC19C  C0 62 E8 64 */	lfs f3, lbl_8041FBE4-_SDA2_BASE_(r2)
...
/* 801DF254 001DC254  40 80 00 0C */	bge lbl_801DF260
/* 801DF258 001DC258  4B E7 E9 2D */	bl effDelete
/* 801DF25C 001DC25C  48 00 00 A8 */	b lbl_801DF304
lbl_801DF260:
...
/* 801DF26C 001DC26C  C0 82 E8 68 */	lfs f4, lbl_8041FBE8-_SDA2_BASE_(r2)
/* 801DF270 001DC270  EC 00 08 28 */	fsubs f0, f0, f1
/* 801DF274 001DC274  C0 62 E8 6C */	lfs f3, lbl_8041FBEC-_SDA2_BASE_(r2)
/* 801DF278 001DC278  C0 42 E8 70 */	lfs f2, lbl_8041FBF0-_SDA2_BASE_(r2)
...
/* 801DF28C 001DC28C  48 00 00 4C */	b lbl_801DF2D8
lbl_801DF290:
...
/* 801DF2E0 001DC2E0  41 80 FF B0 */	blt lbl_801DF290
...
/* 801DF39C 001DC39C  C3 E2 E8 5C */	lfs f31, lbl_8041FBDC-_SDA2_BASE_(r2)
/* 801DF3A0 001DC3A0  90 1F 00 10 */	stw r0, 0x10(r31)
/* 801DF3A4 001DC3A4  38 00 00 00 */	li r0, 0
/* 801DF3A8 001DC3A8  C0 42 E8 74 */	lfs f2, lbl_8041FBF4-_SDA2_BASE_(r2)
...
/* 801DF3B8 001DC3B8  C0 02 E8 78 */	lfs f0, lbl_8041FBF8-_SDA2_BASE_(r2)
