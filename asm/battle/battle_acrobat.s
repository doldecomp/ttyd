...
/* 8018D024 0018A024  C0 02 CE E8 */	lfs f0, lbl_8041E268-_SDA2_BASE_(r2)
/* 8018D028 0018A028  C0 22 CE EC */	lfs f1, lbl_8041E26C-_SDA2_BASE_(r2)
...
/* 8018D084 0018A084  40 82 00 14 */	bne lbl_8018D098
...
/* 8018D0B0 0018A0B0  48 00 01 98 */	b lbl_8018D248
lbl_8018D0B4:
...
/* 8018D0C0 0018A0C0  41 82 00 80 */	beq lbl_8018D140
...
/* 8018D0D0 0018A0D0  40 81 00 70 */	ble lbl_8018D140
/* 8018D0D4 0018A0D4  80 1D 27 24 */	lwz r0, 0x2724(r29)
/* 8018D0D8 0018A0D8  7C 03 00 00 */	cmpw r3, r0
/* 8018D0DC 0018A0DC  41 81 00 64 */	bgt lbl_8018D140
/* 8018D0E0 0018A0E0  3C 60 80 30 */	lis r3, lbl_802F8E08@ha
/* 8018D0E4 0018A0E4  C0 22 CE E8 */	lfs f1, lbl_8041E268-_SDA2_BASE_(r2)
...
/* 8018D148 0018A148  41 82 00 24 */	beq lbl_8018D16C
...
/* 8018D158 0018A158  40 81 00 14 */	ble lbl_8018D16C
/* 8018D15C 0018A15C  80 1D 27 24 */	lwz r0, 0x2724(r29)
/* 8018D160 0018A160  7C 03 00 00 */	cmpw r3, r0
/* 8018D164 0018A164  41 81 00 08 */	bgt lbl_8018D16C
...
/* 8018D174 0018A174  41 81 00 4C */	bgt lbl_8018D1C0
/* 8018D178 0018A178  80 1D 27 34 */	lwz r0, 0x2734(r29)
/* 8018D17C 0018A17C  2C 00 00 00 */	cmpwi r0, 0
/* 8018D180 0018A180  40 81 00 40 */	ble lbl_8018D1C0
/* 8018D184 0018A184  3B E0 00 00 */	li r31, 0
/* 8018D188 0018A188  48 00 00 2C */	b lbl_8018D1B4
lbl_8018D18C:
...
/* 8018D19C 0018A19C  41 82 00 14 */	beq lbl_8018D1B0
...
/* 8018D1AC 0018A1AC  48 00 00 9C */	b lbl_8018D248
lbl_8018D1B0:
...
/* 8018D1BC 0018A1BC  41 80 FF D0 */	blt lbl_8018D18C
lbl_8018D1C0:
...
/* 8018D1CC 0018A1CC  40 82 00 0C */	bne lbl_8018D1D8
/* 8018D1D0 0018A1D0  2C 1E 00 00 */	cmpwi r30, 0
/* 8018D1D4 0018A1D4  41 82 00 50 */	beq lbl_8018D224
lbl_8018D1D8:
...
/* 8018D1E4 0018A1E4  41 81 00 14 */	bgt lbl_8018D1F8
...
/* 8018D1F4 0018A1F4  48 00 00 54 */	b lbl_8018D248
lbl_8018D1F8:
/* 8018D1F8 0018A1F8  80 1D 27 24 */	lwz r0, 0x2724(r29)
/* 8018D1FC 0018A1FC  7C 03 00 00 */	cmpw r3, r0
/* 8018D200 0018A200  41 81 00 14 */	bgt lbl_8018D214
...
/* 8018D210 0018A210  48 00 00 38 */	b lbl_8018D248
lbl_8018D214:
...
/* 8018D220 0018A220  48 00 00 28 */	b lbl_8018D248
lbl_8018D224:
...
/* 8018D230 0018A230  41 80 00 14 */	blt lbl_8018D244
...
/* 8018D240 0018A240  48 00 00 08 */	b lbl_8018D248
lbl_8018D244:
