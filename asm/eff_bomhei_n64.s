...
/* 801AACB4 001A7CB4  C0 42 D6 AC */	lfs f2, lbl_8041EA2C-_SDA2_BASE_(r2)
...
/* 801AAEC8 001A7EC8  C0 22 D6 B0 */	lfs f1, lbl_8041EA30-_SDA2_BASE_(r2)
/* 801AAECC 001A7ECC  38 61 00 68 */	addi r3, r1, 0x68
/* 801AAED0 001A7ED0  C0 42 D6 B4 */	lfs f2, lbl_8041EA34-_SDA2_BASE_(r2)
/* 801AAED4 001A7ED4  C0 62 D6 B8 */	lfs f3, lbl_8041EA38-_SDA2_BASE_(r2)
...
/* 801AAEEC 001A7EEC  C0 22 D6 B8 */	lfs f1, lbl_8041EA38-_SDA2_BASE_(r2)
...
/* 801AAF04 001A7F04  C0 82 D6 BC */	lfs f4, lbl_8041EA3C-_SDA2_BASE_(r2)
...
/* 801AAF38 001A7F38  C0 22 D6 B8 */	lfs f1, lbl_8041EA38-_SDA2_BASE_(r2)
/* 801AAF3C 001A7F3C  2C 00 00 08 */	cmpwi r0, 8
/* 801AAF40 001A7F40  C0 82 D6 BC */	lfs f4, lbl_8041EA3C-_SDA2_BASE_(r2)
...
/* 801AAF6C 001A7F6C  C0 62 D6 B8 */	lfs f3, lbl_8041EA38-_SDA2_BASE_(r2)
...
/* 801AAFD8 001A7FD8  C0 02 D6 C0 */	lfs f0, lbl_8041EA40-_SDA2_BASE_(r2)
...
/* 801AAFF4 001A7FF4  C0 62 D6 C4 */	lfs f3, lbl_8041EA44-_SDA2_BASE_(r2)
...
/* 801AB020 001A8020  C0 22 D6 C0 */	lfs f1, lbl_8041EA40-_SDA2_BASE_(r2)
...
/* 801AB070 001A8070  C0 02 D6 C8 */	lfs f0, lbl_8041EA48-_SDA2_BASE_(r2)
/* 801AB074 001A8074  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 801AB078 001A8078  40 81 00 1C */	ble lbl_801AB094
/* 801AB07C 001A807C  80 02 D6 A0 */	lwz r0, lbl_8041EA20-_SDA2_BASE_(r2)
...
lbl_801AB094:
/* 801AB094 001A8094  80 02 D6 A4 */	lwz r0, lbl_8041EA24-_SDA2_BASE_(r2)
...
lbl_801AB0A8:
/* 801AB0A8 001A80A8  80 02 D6 A8 */	lwz r0, lbl_8041EA28-_SDA2_BASE_(r2)
...
/* 801AB138 001A8138  C0 62 D6 CC */	lfs f3, lbl_8041EA4C-_SDA2_BASE_(r2)
...
/* 801AB2D0 001A82D0  C0 02 D6 B8 */	lfs f0, lbl_8041EA38-_SDA2_BASE_(r2)
...
lbl_801AB308:
/* 801AB308 001A8308  C0 02 D6 D0 */	lfs f0, lbl_8041EA50-_SDA2_BASE_(r2)
