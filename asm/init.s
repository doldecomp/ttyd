...
/* 80003114 00000114  48 25 7E 99 */	bl TRK_fill_mem
...
.global .L_80003154
.L_80003154:
/* 80003154 00000154  4D 65 74 72 */	.4byte 0x4D657472  /* unknown instruction */
/* 80003158 00000158  6F 77 65 72 */	xoris r23, r27, 0x6572
/* 8000315C 0000015C  6B 73 20 54 */	xori r19, r27, 0x2054
/* 80003160 00000160  61 72 67 65 */	ori r18, r11, 0x6765
/* 80003164 00000164  74 20 52 65 */	andis. r0, r1, 0x5265
/* 80003168 00000168  73 69 64 65 */	andi. r9, r27, 0x6465
/* 8000316C 0000016C  6E 74 20 4B */	xoris r20, r19, 0x204b
/* 80003170 00000170  65 72 6E 65 */	oris r18, r11, 0x6e65
/* 80003174 00000174  6C 20 66 6F */	xoris r0, r1, 0x666f
/* 80003178 00000178  72 20 50 6F */	andi. r0, r17, 0x506f
/* 8000317C 0000017C  77 65 72 50 */	andis. r5, r27, 0x7250
.L_80003180:
/* 80003180 00000180  43 00 00 00 */	.4byte 0x43000000  /* unknown instruction */
...
/* 80003254 00000254  48 00 1E 34 */	b func_80005088
...
/* 8000338C 0000038C  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80003390 00000390  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003474 00000474  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80003478 00000478  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003574 00000574  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80003578 00000578  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003674 00000674  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80003678 00000678  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003774 00000774  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80003778 00000778  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003874 00000874  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80003878 00000878  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003974 00000974  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80003978 00000978  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003A74 00000A74  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80003A78 00000A78  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003D74 00000D74  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80003D78 00000D78  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003E74 00000E74  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80003E78 00000E78  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003F74 00000F74  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80003F78 00000F78  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004094 00001094  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80004098 00001098  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 800040C8 000010C8  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 800040CC 000010CC  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 800041B0 000011B0  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 800041B4 000011B4  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 800042B0 000012B0  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 800042B4 000012B4  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 800043B0 000013B0  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 800043B4 000013B4  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004474 00001474  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80004478 00001478  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004574 00001574  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80004578 00001578  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004774 00001774  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80004778 00001778  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004874 00001874  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80004878 00001878  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004D74 00001D74  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80004D78 00001D78  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004E74 00001E74  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80004E78 00001E78  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004F74 00001F74  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80004F78 00001F78  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80005074 00002074  3C 60 80 25 */	lis r3, TRKInterruptHandler@h
/* 80005078 00002078  60 63 B0 B0 */	ori r3, r3, TRKInterruptHandler@l
/* 8000507C 0000207C  7C 7A 03 A6 */	mtspr 0x1a, r3
/* 80005080 00002080  38 60 1F 00 */	li r3, 0x1f00
/* 80005084 00002084  4C 00 00 64 */	rfi 

.global func_80005088
func_80005088:
...
/* 800050A0 000020A0  48 29 04 A1 */	bl OSResetSystem
...
/* 800050C8 000020C8  48 00 00 1D */	bl func_800050E4
...
/* 80005110 00002110  40 82 FF F8 */	bne .L_80005108
.L_80005114:
/* 80005114 00002114  28 07 00 00 */	cmplwi r7, 0
/* 80005118 00002118  41 82 00 1C */	beq .L_80005134
...
/* 8000513C 0000213C  41 82 00 2C */	beq .L_80005168
.L_80005140:
...
/* 800051B0 000021B0  48 00 00 0C */	b .L_800051BC
.L_800051B4:
...
/* 800051C0 000021C0  40 82 FF F4 */	bne .L_800051B4
...
/* 800051D4 000021D4  48 00 00 0C */	b .L_800051E0
.L_800051D8:
...
/* 80005230 00002230  98 0D 1C D0 */	stb r0, 0x1cd0(r13)
/* 80005234 00002234  4E 80 00 20 */	blr 

.global __get_debug_bba
__get_debug_bba:
/* 80005238 00002238  88 6D 1C D0 */	lbz r3, 0x1cd0(r13)
...
/* 8000527C 0000227C  41 82 00 0C */	beq .L_80005288
/* 80005280 00002280  80 E6 00 0C */	lwz r7, 0xc(r6)
/* 80005284 00002284  48 00 00 24 */	b .L_800052A8
.L_80005288:
...
/* 80005298 00002298  41 82 00 4C */	beq .L_800052E4
...
/* 800052B0 000022B0  41 82 00 24 */	beq .L_800052D4
/* 800052B4 000022B4  28 07 00 03 */	cmplwi r7, 3
/* 800052B8 000022B8  38 A0 00 01 */	li r5, 1
/* 800052BC 000022BC  41 82 00 18 */	beq .L_800052D4
/* 800052C0 000022C0  28 07 00 04 */	cmplwi r7, 4
/* 800052C4 000022C4  40 82 00 20 */	bne .L_800052E4
/* 800052C8 000022C8  38 A0 00 02 */	li r5, 2
/* 800052CC 000022CC  4B FF FF 61 */	bl __set_debug_bba
/* 800052D0 000022D0  48 00 00 14 */	b .L_800052E4
.L_800052D4:
/* 800052D4 000022D4  3C C0 80 26 */	lis r6, InitMetroTRK@ha
/* 800052D8 000022D8  38 C6 CF 80 */	addi r6, r6, InitMetroTRK@l
...
/* 800052F4 000022F4  41 A2 00 50 */	beq+ .L_80005344
/* 800052F8 000022F8  80 C5 00 08 */	lwz r6, 8(r5)
/* 800052FC 000022FC  28 06 00 00 */	cmplwi r6, 0
/* 80005300 00002300  41 A2 00 44 */	beq+ .L_80005344
...
/* 80005310 00002310  41 82 00 34 */	beq .L_80005344
...
/* 8000532C 0000232C  42 00 FF F0 */	bdnz .L_8000531C
...
/* 80005340 00002340  48 00 00 0C */	b .L_8000534C
.L_80005344:
/* 80005344 00002344  39 C0 00 00 */	li r14, 0
/* 80005348 00002348  39 E0 00 00 */	li r15, 0
.L_8000534C:
/* 8000534C 0000234C  48 28 9D 89 */	bl DBInit
/* 80005350 00002350  48 28 9F FD */	bl OSInit
...
/* 80005364 00002364  41 82 00 10 */	beq .L_80005374
/* 80005368 00002368  70 63 7F FF */	andi. r3, r3, 0x7fff
/* 8000536C 0000236C  28 03 00 01 */	cmplwi r3, 1
/* 80005370 00002370  40 82 00 08 */	bne .L_80005378
.L_80005374:
...
/* 80005380 00002380  40 82 00 08 */	bne .L_80005388
/* 80005384 00002384  48 25 7C 95 */	bl InitMetroTRK_BBA
.L_80005388:
/* 80005388 00002388  48 29 2A E5 */	bl __init_user
/* 8000538C 0000238C  7D C3 73 78 */	mr r3, r14
/* 80005390 00002390  7D E4 7B 78 */	mr r4, r15
/* 80005394 00002394  48 00 02 4D */	bl main
/* 80005398 00002398  48 25 9E 00 */	b exit
...
/* 80005410 00002410  3C 20 80 43 */	lis r1, 0x80433368@h
/* 80005414 00002414  60 21 33 68 */	ori r1, r1, 0x80433368@l
/* 80005418 00002418  3C 40 80 42 */	lis r2, lbl_80421380@h
/* 8000541C 0000241C  60 42 13 80 */	ori r2, r2, lbl_80421380@l
/* 80005420 00002420  3D A0 80 41 */	lis r13, lbl_80417260@h
/* 80005424 00002424  61 AD 72 60 */	ori r13, r13, lbl_80417260@l
...
/* 80005444 00002444  3C 60 80 00 */	lis r3, .L_80005544@ha
/* 80005448 00002448  38 03 55 44 */	addi r0, r3, .L_80005544@l
/* 8000544C 0000244C  7C 1D 03 78 */	mr r29, r0
/* 80005450 00002450  48 00 00 04 */	b .L_80005454
.L_80005454:
/* 80005454 00002454  48 00 00 04 */	b .L_80005458
.L_80005458:
/* 80005458 00002458  83 DD 00 08 */	lwz r30, 8(r29)
/* 8000545C 0000245C  28 1E 00 00 */	cmplwi r30, 0
/* 80005460 00002460  41 82 00 38 */	beq .L_80005498
/* 80005464 00002464  80 9D 00 00 */	lwz r4, 0(r29)
/* 80005468 00002468  83 FD 00 04 */	lwz r31, 4(r29)
/* 8000546C 0000246C  41 82 00 24 */	beq .L_80005490
/* 80005470 00002470  7C 1F 20 40 */	cmplw r31, r4
/* 80005474 00002474  41 82 00 1C */	beq .L_80005490
/* 80005478 00002478  7F E3 FB 78 */	mr r3, r31
/* 8000547C 0000247C  7F C5 F3 78 */	mr r5, r30
/* 80005480 00002480  4B FF FD 1D */	bl func_8000519C
...
/* 80005494 00002494  4B FF FF C4 */	b .L_80005458
.L_80005498:
/* 80005498 00002498  3C 60 80 00 */	lis r3, .L_800055B0@ha
/* 8000549C 0000249C  38 03 55 B0 */	addi r0, r3, .L_800055B0@l
/* 800054A0 000024A0  7C 1D 03 78 */	mr r29, r0
/* 800054A4 000024A4  48 00 00 04 */	b .L_800054A8
.L_800054A8:
/* 800054A8 000024A8  48 00 00 04 */	b .L_800054AC
.L_800054AC:
/* 800054AC 000024AC  80 BD 00 04 */	lwz r5, 4(r29)
/* 800054B0 000024B0  28 05 00 00 */	cmplwi r5, 0
/* 800054B4 000024B4  41 82 00 1C */	beq .L_800054D0
/* 800054B8 000024B8  80 7D 00 00 */	lwz r3, 0(r29)
/* 800054BC 000024BC  41 82 00 0C */	beq .L_800054C8
/* 800054C0 000024C0  38 80 00 00 */	li r4, 0
/* 800054C4 000024C4  4B FF FB F1 */	bl memset
.L_800054C8:
/* 800054C8 000024C8  3B BD 00 08 */	addi r29, r29, 8
/* 800054CC 000024CC  4B FF FF E0 */	b .L_800054AC
.L_800054D0:
...
/* 800054FC 000024FC  48 28 A6 FD */	bl __OSPSInit
/* 80005500 00002500  48 28 9C C1 */	bl __OSFPRInit
/* 80005504 00002504  48 28 BA 7D */	bl __OSCacheInit
...
/* 80005538 00002538  40 80 FF EC */	bge .L_80005524
...
/* 80005558 00002558  00 2B B8 EC */	.4byte 0x002BB8EC  /* unknown instruction */
/* 8000555C 0000255C  80 2C 0E E0 */	lwz r1, 0xee0(r12)
/* 80005560 00002560  80 2C 0E E0 */	lwz r1, 0xee0(r12)
/* 80005564 00002564  00 00 00 04 */	.4byte 0x00000004  /* unknown instruction */
/* 80005568 00002568  80 2C 0F 00 */	lwz r1, 0xf00(r12)
/* 8000556C 0000256C  80 2C 0F 00 */	lwz r1, 0xf00(r12)
/* 80005570 00002570  00 00 00 08 */	.4byte 0x00000008  /* unknown instruction */
/* 80005574 00002574  80 2C 0F 20 */	lwz r1, 0xf20(r12)
/* 80005578 00002578  80 2C 0F 20 */	lwz r1, 0xf20(r12)
/* 8000557C 0000257C  00 04 1C E8 */	.4byte 0x00041CE8  /* unknown instruction */
/* 80005580 00002580  80 30 2C 20 */	lwz r1, 0x2c20(r16)
/* 80005584 00002584  80 30 2C 20 */	lwz r1, 0x2c20(r16)
/* 80005588 00002588  00 0B EB BC */	.4byte 0x000BEBBC  /* unknown instruction */
/* 8000558C 0000258C  80 40 F2 60 */	lwz r2, -0xda0(0)
/* 80005590 00002590  80 40 F2 60 */	lwz r2, -0xda0(0)
/* 80005594 00002594  00 00 90 F4 */	.4byte 0x000090F4  /* unknown instruction */
/* 80005598 00002598  80 41 93 80 */	lwz r2, -0x6c80(r1)
/* 8000559C 0000259C  80 41 93 80 */	lwz r2, -0x6c80(r1)
/* 800055A0 000025A0  00 00 9B DC */	.4byte 0x00009BDC  /* unknown instruction */
...
.L_800055B0:
/* 800055B0 000025B0  80 3C 17 E0 */	lwz r1, 0x17e0(r28)
/* 800055B4 000025B4  00 04 DA 70 */	.4byte 0x0004DA70  /* unknown instruction */
/* 800055B8 000025B8  80 41 83 60 */	lwz r2, -0x7ca0(r1)
/* 800055BC 000025BC  00 00 10 18 */	.4byte 0x00001018  /* unknown instruction */
/* 800055C0 000025C0  80 42 2F 60 */	lwz r2, 0x2f60(r2)
/* 800055C4 000025C4  00 00 04 04 */	.4byte 0x00000404  /* unknown instruction */
