...
void LCAlloc(void * addr, u32 nBytes) {
    ...
    ASSERTMSGLINE(0x527, !((u32)addr & 31), "LCAlloc(): addr must be 32 byte aligned");
    ASSERTMSGLINE(0x529, !((u32)nBytes & 31), "LCAlloc(): nBytes must be 32 byte aligned");
...
void LCAllocNoInvalidate(void * addr, u32 nBytes) {
    ...
    ASSERTMSGLINE(0x556, !((u32)addr & 31), "LCAllocNoFlush(): addr must be 32 byte aligned");
    ASSERTMSGLINE(0x558, !((u32)nBytes & 31), "LCAllocNoFlush(): nBytes must be 32 byte aligned");
...
u32 LCLoadData(void* destAddr, void* srcAddr, u32 nBytes) {
  ...
  ASSERTMSGLINE(0x592, !((u32)srcAddr & 31), "LCLoadData(): srcAddr not 32 byte aligned");
  ASSERTMSGLINE(0x594, !((u32)destAddr & 31), "LCLoadData(): destAddr not 32 byte aligned");
...
u32 LCStoreData(void* destAddr, void* srcAddr, u32 nBytes) {
  ...
  ASSERTMSGLINE(0x5D6, !((u32)srcAddr & 31), "LCStoreData(): srcAddr not 32 byte aligned");
  ASSERTMSGLINE(0x5D8, !((u32)destAddr & 31), "LCStoreData(): destAddr not 32 byte aligned");
