...
__OSInterruptHandler
  ...
  ASSERTMSGLINE(0x19B, InterruptHandlerTable, "__OSSetInterruptHandler(): OSInit() must be called in advance.");
  ASSERTMSGLINE(0x19D, interrupt < 0x20, "__OSSetInterruptHandler(): unknown interrupt.");
...
__OSInterruptHandler __OSGetInterruptHandler(__OSInterrupt interrupt) {
  ASSERTMSGLINE(0x1B1, InterruptHandlerTable, "__OSGetInterruptHandler(): OSInit() must be called in advance.");
  ASSERTMSGLINE(0x1B3, interrupt < 0x20, "__OSGetInterruptHandler(): unknown interrupt.");
