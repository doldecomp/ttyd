...
typedef enum MarioFlags {
	MARIO_FLAG_ACTIVE = 0x1,
	MARIO_FLAG_CTRL_OFF = 0x2,
	MARIO_FLAG_CTRL_OFF_2 = 0x4,
	MARIO_FLAG_KEY_OFF = 0x8,
	MARIO_FLAG_FORCED_MOVEMENT = 0x20,
	MARIO_FLAG_USE_FORCE_DIRECTION = 0x40,
	MARIO_FLAG_STOP_AIR_MOVEMENT = 0x80,
	MARIO_FLAG_FLOORS_DISABLED = 0x100,
	MARIO_FLAG_FORCE_WALL = 0x200,
	MARIO_FLAG_WALLS_DISABLED = 0x400,
	MARIO_FLAG_HAMMER_HIT_WALL = 0x800,
	MARIO_FLAG_PRE_BATTLE_PHYSICS = 0x1000,
	MARIO_FLAG_IS_CARRYING_BOBBERY = 0x2000,
	MARIO_FLAG_ITEM_GET_DISABLED = 0x4000,
	MARIO_FLAG_IS_PUSHING = 0x8000,
	MARIO_FLAG_IS_JUMPING = 0x10000,
	MARIO_FLAG_IS_FALLING = 0x20000,
	MARIO_FLAG_IS_STEPPING = 0x40000,
	MARIO_FLAG_HAS_INPUT_JUMP = 0x80000,
	MARIO_FLAG_PAPER_MODE = 0x100000,
	MARIO_FLAG_GONE_THROUGH_BARS = 0x200000,
	MARIO_FLAG_PARTY_WALK_DISABLED = 0x400000,
	MARIO_FLAG_SLIT_ABILITY_DISABLED = 0x800000,
	MARIO_FLAG_TUBE_MODE = 0x1000000,
	MARIO_FLAG_BG_MODE = 0x2000000,
	MARIO_FLAG_IN_SHALLOW_WATER = 0x4000000,
	MARIO_FLAG_IS_TOUCHING_CEILING = 0x8000000,
	MARIO_FLAG_CHG_MOT_DISABLED = 0x10000000,
	MARIO_FLAG_IS_SHADOW_MARIO = 0x40000000,
	MARIO_FLAG_IS_8_BIT = 0x80000000
} MarioFlags;
#pragma enumsalwaysint on
